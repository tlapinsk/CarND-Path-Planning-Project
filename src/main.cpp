      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Main car's localization Data
            ...
            // Setup vector for lanes
            vector<bool> empty_lane = {true, true, true};
            empty_lane[lane] = false;
            ...
            // In Frenet add evening 30m spaced points ahead of the starting reference
